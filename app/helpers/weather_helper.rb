module WeatherHelper
  ...
  def wind_matcher(speed)
    ...
    elsif (0.71..3.40).include?(speed) then "wi wi-beafort-1 text-info"
    elsif (3.41..7.40).include?(speed) then "wi wi-beafort-2 text-info"
    elsif (7.41..12.20).include?(speed) then "wi wi-beafort-3 text-success"
    elsif (12.21..17.90).include?(speed) then "wi wi-beafort-4 text-success"
    elsif (17.91..24.10).include?(speed) then "wi wi-beafort-5 text-success"
    elsif (24.11..31.00).include?(speed) then "wi wi-beafort-6 text-warning"
    elsif (31.01..38.40).include?(speed) then "wi wi-beafort-7 text-warning"
    elsif (38.41..46.30).include?(speed) then "wi wi-beafort-8 text-danger"
    elsif (46.31..54.80).include?(speed) then "wi wi-beafort-9 text-danger"
    elsif (54.81..63.60).include?(speed) then "wi wi-beafort-10 text-danger"
